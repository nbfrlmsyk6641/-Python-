...
# --- 1. 配置输入和输出文件路径 ---
# ⚠️ 请在这里修改你的输入文件夹和文件名
input_folder = r'C:\Users\23688\Desktop\实验数据\0809\ISE数据'
input_filename = 'sdd_303.csv'

# ⚠️ 请在这里修改你希望保存结果的文件夹
output_folder = r'C:\Users\23688\Desktop\实验数据\0809\ISE数据\处理后的数据\ISE数据'
output_filename = 'ISE_4.csv'
