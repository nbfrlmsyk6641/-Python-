...
# # --- 1. 配置输入和输出文件路径 ---
# # ⚠️ 请在这里修改你的输入文件夹和文件名
# input_folder = r'C:\Users\23688\Desktop\实验数据\0805\非0开始\原始导出数据'
# input_filename = 'sdd_249.csv'

# # ⚠️ 请在这里修改你希望保存结果的文件夹
# output_folder = r'C:\Users\23688\Desktop\实验数据\0805\非0开始\处理后的数据'
# output_filename = '400_200_0wm.csv'
...
# # ⚠️ 请在这里修改你的输入文件夹和文件名
# input_folder = r'C:\Users\23688\Desktop\实验数据\0805\非0开始\原始导出数据'
# input_filename = 'sdd_250.csv'

# # ⚠️ 请在这里修改你希望保存结果的文件夹
# output_folder = r'C:\Users\23688\Desktop\实验数据\0805\非0开始\处理后的数据'
# output_filename = '400_200_0Te.csv'  
...
# ⚠️ 请在这里修改你的输入文件夹和文件名
input_folder = r'C:\Users\23688\Desktop\实验数据\0805\非0开始\原始导出数据'
input_filename = 'sdd_251.csv'

# ⚠️ 请在这里修改你希望保存结果的文件夹
output_folder = r'C:\Users\23688\Desktop\实验数据\0805\非0开始\处理后的数据'
output_filename = '400_200_0_u_y.csv' 
