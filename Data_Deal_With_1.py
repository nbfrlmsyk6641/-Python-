...
# --- 1. 配置输入和输出文件路径 ---
# ⚠️ 请在这里修改你的输入文件夹和文件名
input_folder = r'F:\实验数据\0820\特征数据\谐振模态\第三次采集'
input_filename = 'wm.csv'

# ⚠️ 请在这里修改你希望保存结果的文件夹
output_folder = r'F:\实验数据\0820\特征数据\谐振模态\第三次采集\处理后的数据'
output_filename = '0820_wm_R_3.csv'
...
# # ⚠️ 请在这里修改你的输入文件夹和文件名
# input_folder = r'F:\实验数据\0820\特征数据\谐振模态\第三次采集'
# input_filename = 'Te_TL_Ts.csv'

# # ⚠️ 请在这里修改你希望保存结果的文件夹
# output_folder = r'F:\实验数据\0820\特征数据\谐振模态\第三次采集\处理后的数据'
# output_filename = '0820_Te_TL_Ts_R_3.csv'  
...
#         skiprows=28,
#         header=None,
#         usecols=[1, 2, 3, 4]  # 读取B, C, D, E列
#     )

#     # --- 3. 重命名列名 ---
#     # 【已修改】将列名设置为 'Time' 和 'Te'
#     df.columns = ['Time', 'Te', 'TL', 'Ts']
...
# # ⚠️ 请在这里修改你希望保存结果的文件夹
# output_folder = r'F:\实验数据\0820\特征数据\谐振模态\第三次采集\处理后的数据'
# output_filename = '0820_Feature_R_3.csv'
...
#     print(f"✅ 处理成功！")
#     print(f"已从第29行开始提取B, C, D, E列数据。")
#     print(f"重命名列为 'Time', 'F1', 'F2', 'F3', 'F4', 'F5', 'F6'。")
#     print(f"结果已完整保存到文件: {output_file_path}")
