...
# # 定义输入文件名 
# input_filename = '0831_Alpha_19.csv'

# # 定义输出文件名
# output_filename = 'Alpha_19.csv'
...
# # 定义输入和输出文件夹的路径
# input_folder = r'F:\实验数据\0831\24' 
# output_folder = r'F:\实验数据\0831\24' 

# # 定义输入文件名
# input_filename = '0831_Wm_24.csv' # ⚠️ 请替换为您的文件名

# # 定义输出文件名
# output_filename = 'Wm_6.5s_to_8.0s.csv'
...
# # 定义需要提取的原始时间范围 (单位：秒)
# start_time_original = 6.5
# end_time_original = 8.0
